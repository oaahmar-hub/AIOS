...
- `Exact`: `43` rows (3.5%)
- `High-confidence`: `710` rows (57.1%)
- `Partial`: `294` rows (23.6%)
- `Weak`: `0` rows (0.0%)
- `Unusable`: `197` rows (15.8%)

## Remaining Data Gaps

- `missing_unit_number`: `1031`
- `missing_hard_property_identifier`: `710`
- `missing_broker_or_building_anchor`: `294`
- `no_public_bridge_reference`: `197`

## Highest-Value Source Uplift

- `BAYUT OVER ALL LEAD.xlsx`: uplift `657.0`, Exact `0`, High-confidence `635`, Partial `44`, Weak `0`, Unusable `1`
