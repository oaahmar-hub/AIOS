...
- `missing_unit_number`: `1001`
- `missing_hard_property_identifier`: `681`
- `missing_broker_or_building_anchor`: `293`
- `no_public_bridge_reference`: `197`
- `missing_cpid_link_or_hard_identifier`: `30`

## Highest-Value Source Uplift

- `BAYUT OVER ALL LEAD.xlsx`: uplift `648.3`, Exact `0`, High-confidence `606`, Partial `44`, Weak `29`, Unusable `1`
